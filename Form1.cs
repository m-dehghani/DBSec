...
namespace DBSec
{
    public partial class Form1 : Form
    {
        ...
        private async void Button1_Click(object sender, EventArgs e)
        {
            ...
            var constr = Utility.MakeConnectionStr(txt_ServerIP.Text, txt_DB.Text,
                ...
                try
                {
                  await  conn.OpenAsync();
                   var comm = string.Format(@"use master;
                    ...
                    label2.Text = "certificate با موفقیت کپی شد";
                    ...
                    command.ExecuteNonQuery();
                    label3.Text = "Master Key با موفقیت کپی شد";
                    conn.Close();
                }
                catch (Exception ex)
                {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            label2.Text = label3.Text =label10.Text= label11.Text="";
        }
        ...
        private async void Button7_Click(object sender, EventArgs e)
        {
            try
            {
                SqlConnection conn = new SqlConnection(Utility.MakeConnectionStr(txt_ServerIP.Text, "master",
                      Utility.ToInsecureString(Utility.DBPass)));
                ...
                SqlCommand command = new SqlCommand(string.Format(@"USE master;
                                                      ...
                                                      ALTER DATABASE {1}
                                                      SET ENCRYPTION ON;", Utility.ToInsecureString(Utility.DBPass),txt_DB),
                                                      conn);
            ...
            using (SqlConnection conn = new SqlConnection(Utility.MakeConnectionStr(txt_ServerIP.Text, txt_DB.Text, textBox4.Text)))
            {
                try
                {
                    ...
                    SqlCommand comm = new SqlCommand(
                      ...
                      string.Format( @"ALTER LOGIN [sa] WITH DEFAULT_DATABASE=[master]
                        USE [master]
                        ALTER LOGIN [sa] WITH PASSWORD=N'{0}' ",Utility.ToInsecureString(Utility.DBPass)), conn);
